const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'apis': 'API Management',
    'apis_docs': 'Swagger Docs',
    'task': 'Task Management',
    'task_job': 'Scheduled Tasks',
    'task_scheduler': 'Scheduler Monitor',
    'task_node': 'Node Management',
  },
  page: {
    task: {
      job: {
        ...
        jobType: 'Job Type',
        typeFunction: 'Built-in Function',
        ...
        triggerDate: 'Specific Time',
        cronExpr: 'CRON Expression',
        cronRule: 'CRON expression is required',
        ...
        lastRunAt: 'Last Run',
        runOnce: 'Test',
        runOnceSent: 'Triggered, check the result later',
        pause: 'Pause',
        pauseConfirm: 'Pause this task?',
        resume: 'Resume',
        logs: 'Logs',
        logTitle: 'Execution History',
        execStatus: 'Status',
      ...
      scheduler: {
        ...
        resume: 'Resume',
        shutdown: 'Shutdown',
        shutdownConfirm: 'Shutdown the scheduler? All tasks will stop scheduling',
        clearJobs: 'Clear Jobs',
        clearConfirm: 'Remove all jobs from the scheduler?',
        console: 'Console',
        consoleTitle: 'Scheduler Console',
        consoleTip: 'Auto refresh every 3s',
        keyword: 'Keyword filter',
        test: 'Test',
        cardRunning: 'Running',
        cardPaused: 'Paused',
        noNextRun: 'Unscheduled',
        metricsTitle: 'Metrics',
        uptime: 'Uptime',
        mem: 'Memory',
        todayTotal: 'Runs Today',
        successRate: 'Success Rate',
        avgDuration: 'Avg Duration',
        todayFailed: 'Failures Today',
        alerts: 'Alerts',
        alertsEmpty: 'No alerts, all good',
        recentLogs: 'Recent Executions',
        alertBanner: '{count} alert(s) detected, please handle them!',
        normalBanner: 'Scheduler is running normally, tasks are dispatched as planned'
      },
      node: {
        title: 'Node List',
        name: 'Node Name',
        nodeId: 'Node ID',
        nodeIdTip: 'Unique node id (nodeId)',
        host: 'Host',
        port: 'Port',
    ...
    login: {
      common: {
        ...
        captchaPlaceholder: 'Please enter the result',
    ...
    system: {
      ...
      role: {
        ...
        action: { assignMenus: 'Assign Menus', assignPermission: 'Assign Permissions' },
        assign: { dataAuth: 'Data Authorization', dataAuthTip: 'Set the visible data scope of the role', menuAuth: 'Menu Authorization', menuAuthTip: 'Check the menus and buttons accessible to the role', searchMenu: 'Search menu', expand: 'Expand', collapse: 'Collapse', parentLinkage: 'Parent-child Linkage' }
      },
      menu: {
    ...
    monitor: {
      ...
      cache: {
        ...
        deleteCategoryConfirm: 'Are you sure you want to delete all cache keys in this category? They will be rebuilt on next access.',
        ...
        remark: 'Remark',
        selectCategoryTip: 'Please select a cache category first',
        selectKeyTip: 'Click a key to view its content',
        monitorInfoTab: 'Monitor Info',
        cacheManageTab: 'Cache Manager',
        redisInfo: 'Redis Monitor Info',
